...
def main():
    ...
    for i in range(n):
     ...
     #   preds1= model1.predict_proba(X_cv)[:, 1]
        ...
        mean_auc += roc_auc
        #fpr1,tpr1,thresholds = metrics.roc_curve(y_cv,preds1)
        #roc_auc1 = metrics.auc(fpr1,tpr1)
        #print("AUC1(fold %d/%d): %f" %(i+1,n,roc_auc1))
        #mean_auc1 += roc_auc1

    print ("Mean AUC: %f" % (mean_auc/n))
    #print("Mean1 AUC: %f" % (mean_auc1/n)) 
    # === Predictions === #
